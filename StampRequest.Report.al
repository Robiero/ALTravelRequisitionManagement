Report 51107 "Stamp Request"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/StampRequest.rdlc';
    ...
    dataset
    {
        dataitem("Travel Request Header";"Travel Request Header")
        {
            ...
            column(ProcManagerApprovalDate_TravelRequestHeader;"Travel Request Header"."Proc Manager Approval Date")
            {
            }
            column(StampTypes_TravelRequestHeader;"Travel Request Header"."Stamp Types")
            {
            }
            column(StampName_TravelRequestHeader;"Travel Request Header"."Stamp Name")
            {
            }
